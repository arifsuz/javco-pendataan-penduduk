...
<body>
    ...
    <div id="login-container">
        ...
        <footer class="text-muted text-center animation-pullUp">
            <small><span>2023</span> &copy; <a href="https://fasilkom.mercubuana.ac.id/" target="_blank">FASILKOM.UMB</a> | Repost by <a href="https://linktr.ee/jav.co" title="JAV.CO" target="_blank">JAVCO</a></small>
        </footer>
        <!-- END Footer -->
    </div>
    <!-- END Login Container -->
